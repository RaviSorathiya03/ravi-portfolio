...
Command: npx gltfjsx@6.5.3 model4.glb -T 
Files: model4.glb [4.26MB] > /Users/ravisorathiya/Documents/raviPortfolio/frontend/public/models/model4-transformed.glb [1.49MB] (65%)
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF('/model4-transformed.glb')
